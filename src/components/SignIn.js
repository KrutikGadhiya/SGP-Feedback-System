  ...
  const handleVerification = (resend = false) => {
    ...
    axios
      ...
      .then((res) => {
        ...
        if (resend) {
          ...
          dispatch(
            openSnack({
              message:
                "E-mail Verified Successfully, Please try to Login Again",
              type: "success",
            })
          );
          dispatch(reset());
      ...
      .catch((err) => {
        ...
        dispatch(reset());
        dispatch(
          openSnack({ message: err.response.data.message, type: "success" })
        );
      });
  };
  const handleSubmit = () => {
    ...
    axios
      ...
      .then((res) => {
        ...
        if (!res.data.isVerified) {
          ...
          dispatch(
            openSnack({ message: "Successfully SignedIN", type: "success" })
          );
    ...
    <>
      <ThemeProvider theme={theme}>
        ...
        >
          ...
          <DialogContent>
            <DialogContentText>
              Please Verify your Email, an 6 - digit Verification code was sent
              to your E-mail.
            </DialogContentText>
            <TextField
              autoFocus
